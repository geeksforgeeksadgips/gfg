...
const themesData = [
  {
    ...
    title: "FinTech",
    description:
      "Revolutionary financial technology solutions for modern banking and payments",
    icon: FaCreditCard,
  ...
  },
  {
    ...
    title: "Ed-Tech",
    description:
      "Innovative educational platforms and learning management systems",
  ...
  },
  {
    ...
    title: "Health",
    description:
      "Healthcare technology solutions improving patient care and medical processes",
    icon: FaHospital,
  ...
  },
  {
    ...
    title: "AgriTech",
    description:
      "Smart farming solutions using IoT, AI and sustainable technology",
    icon: FaSeedling,
    color: "from-emerald-400 to-green-500",
    bgColor: "bg-emerald-500/10",
    borderColor: "border-emerald-500/20",
  },
  {
    ...
    title: "Smart India",
    description:
      "Digital transformation solutions for smart cities and governance",
    icon: FaCity,
    color: "from-green-400 to-emerald-500",
    bgColor: "bg-green-500/10",
    borderColor: "border-green-500/20",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {themesData.map((theme, index) => (
            ...
            >
              {/* Glow Effect */}
              <div
                className={`absolute inset-0 bg-gradient-to-r ${theme.color} rounded-2xl blur-xl opacity-0 group-hover:opacity-20 transition-opacity duration-500`}
              />

              <div
                className={`relative ${theme.bgColor} backdrop-blur-sm border ${theme.borderColor} rounded-2xl p-8 h-full hover:border-opacity-50 transition-all duration-300 bg-gradient-to-br from-gray-800/30 to-gray-900/20`}
              >
                {/* Theme Icon */}
        ...
        >
          <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 backdrop-blur-sm border border-gray-800 rounded-2xl p-8 max-w-4xl mx-auto">
            ...
            <p className="text-gray-300 text-lg mb-6">
              Don't worry! You can also propose your own innovative theme and
