  ...
  const faqData = [
    {
      ...
      answer:
        "Live The Code 4.0 is a 24-hour hackathon organized by GeeksForGeeks ADGIPS Campus Chapter. It's a platform for students to showcase their coding skills, collaborate with peers, and develop innovative solutions to real-world problems.",
    },
    {
      id: 2,
      question: "Who can participate?",
      answer:
        "The hackathon is open to all students from ADGIPS and other universities. Whether you're a beginner or an experienced developer, everyone is welcome to participate and learn.",
    },
    {
      id: 3,
      question: "What are the themes for the hackathon?",
      answer:
        "We have six exciting themes: FinTech, Ed-Tech, Web 3.0, Health, AgriTech, and Smart India. Participants can choose any theme that interests them or propose their own innovative idea.",
    },
    {
      id: 4,
      question: "How do I register for the event?",
      answer:
        "Registration is simple! Click on the 'Register Now' button on our website, fill out the registration form with your details, and you'll receive a confirmation email with further instructions.",
    },
    {
      id: 5,
      question: "What should I bring to the hackathon?",
      answer:
        "Bring your laptop, charger, and any necessary development tools. We'll provide food, drinks, and a comfortable workspace. Don't forget to bring your creativity and enthusiasm!",
    },
    {
      id: 6,
      question: "Are there any prizes?",
      answer:
        "Yes! We have exciting prizes for the top teams, including cash prizes, tech gadgets, and internship opportunities. There are also special prizes for the best theme-specific solutions.",
    },
    {
      id: 7,
      question: "Can I participate as an individual or do I need a team?",
      answer:
        "You can participate as an individual or form a team of up to 4 members. We encourage team participation as it often leads to more innovative solutions, but solo participants are also welcome.",
    },
    {
      id: 8,
      question: "What if I'm new to coding?",
      answer:
        "No worries! This hackathon is perfect for beginners. We'll have mentors available to help you, and there will be workshops and sessions to guide you through the development process.",
    },
    {
      id: 9,
      question: "How will the judging be done?",
      answer:
        "Projects will be judged based on innovation, technical implementation, user experience, and potential impact. Our panel of industry experts and faculty members will evaluate each project fairly.",
    },
    {
      id: 10,
      question: "Will there be food and refreshments?",
      answer:
        "Absolutely! We'll provide breakfast, lunch, dinner, and snacks throughout the 24-hour period. Coffee and energy drinks will also be available to keep you energized.",
    },
  ];
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-gray-400 max-w-2xl mx-auto">
            Find answers to the most common questions about Live The Code 4.0
            hackathon
          </p>
        </motion.div>
