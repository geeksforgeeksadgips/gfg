...
const AboutSection = () => {
  const features = [
    ...
    },
    {
      ...
      title: "Innovate",
      description:
        "Develop creative solutions and push the boundaries of technology.",
    },
    {
      icon: FaGraduationCap,
      title: "Learn",
      description:
        "Gain insights from industry experts through workshops and mentorship.",
    },
    {
      icon: FaTrophy,
      title: "Win",
      description:
        "Win exciting prizes and recognition for your innovative projects.",
    },
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          ...
          >
            ...
            >
              ...
              , an exhilarating hackathon hosted by the{" "}
              <span className="text-emerald-400 font-semibold">
                GFG ADGIPS society
              </span>
              ! This event is designed to bring together the brightest minds in
              coding, innovation, and problem-solving.
            </motion.p>
            ...
            >
              ...
              is your chance to showcase your skills, collaborate with
              like-minded individuals, and create groundbreaking solutions.
            </motion.p>
          </motion.div>
