...
const Footer = () => {
  ...
  return (
    <footer
      className="bg-gradient-to-br from-black via-gray-900 to-black border-t border-green-500/20 relative overflow-hidden"
      id="contact"
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          >
            <div className="flex items-center space-x-2 mb-6">
              <div className="w-10 h-10 bg-gradient-to-r from-green-400 to-emerald-400 rounded-lg flex items-center justify-center">
                <span className="text-black font-bold text-lg">GFG</span>
              </div>
              <div className="text-white font-bold text-2xl">
                GeeksForGeeks <span className="text-green-400">ADGIPS</span>
              </div>
            </div>
            <p className="text-gray-300 text-lg leading-relaxed mb-6 max-w-md">
              Join GeeksForGeeks ADGIPS Campus Chapter for an exhilarating
              24-hour coding marathon where innovation meets technology.
            </p>
        ...
        >
          <p className="text-gray-400 text-sm mb-4 sm:mb-0">
            © {new Date().getFullYear()} GFG ADGIPS | All rights reserved.
          </p>
        </motion.div>
      </div>
